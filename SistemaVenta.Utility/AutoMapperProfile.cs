...
namespace SistemaVenta.Utility
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            #region Usuario
            /* Para mapear el rol de usuario se debe obtener la propiedad RolDescripcion 
             * de la clase UsuarioDTO, para ello se debe obtener la propiedad IdRolNavigation
             * de la clase Usuario de la cual obtendremos el Nombre
             */
