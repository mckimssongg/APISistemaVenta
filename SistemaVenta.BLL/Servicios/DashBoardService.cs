...
namespace SistemaVenta.BLL.Servicios
{
    public class DashBoardService: IDashBoardService
    {
        ...
        private IQueryable<Venta> retornarVentas(IQueryable<Venta> tablaVenta, int restarCantidadDias)
        {
            ...
            ultimaFecha = ultimaFecha.HasValue ? ultimaFecha.Value.AddDays(restarCantidadDias) : DateTime.Now.AddDays(restarCantidadDias);

            return tablaVenta.Where(x => x.FechaRegistro >= ultimaFecha);
        }
        ...
        private async Task<int> TotalVentasUltimaSemana()
        {
            ...
            {
                var tabalVenta = retornarVentas(_ventaQuery, -7);
                total = tabalVenta.Count();
            }
            return total;
        }
        ...
        private async Task<Dictionary<string, int>> VentasUltimaSemana() {
            ...
            if (_ventaQuery.Count() > 0)
            {
                ...
                //Por cada dia retornamos la cantidad
